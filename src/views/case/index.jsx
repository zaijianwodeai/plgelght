...
class Case extends React.Component{
  ...
  getCaseBanner() {
    axios.post('/mnode/case/topBannerWap').then(response => {
  ...
  getWonderful() {
    axios.post('/mnode/case/wonderfulCaseSimple').then(response => {
      let result = response.data
      this.setState({
  ...
  getLabelNavigation() {
    axios.post('/category/getLabelNavigation').then(response => {
      let result = response.data
      let arr = [{title:'猜你喜欢'}]
